...
function breakStatement(numero) {
  ...
  // Devolver el array
  // Si en algún momento el valor de la promedio y la cantidad de iteraciones coinciden, debe interrumpirse la ejecución y 
...
function promediorLikesDeUsuario(usuario) {
  // "usuario" tiene una propiedad llamada "posts" que es un array
  // "posts" es un array de objetos "post"
  // Cada objeto "post" tiene una propiedad llamada "likes" que es un entero
  // promedio todos los likes de todos los objetos "post"
  // Devuelve la promedio
  // Tu código:
