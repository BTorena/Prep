...
function filter(array) {
  ...
  // Tu código:
  // var filterNum = array.filter(function(elemento) {
  //   return elemento[0] === 'a';
  // },0);
 var filterNum = array.filter(function(element){
    return element[0] === 'a';
  });
  return filterNum;
}
...
function deObjetoArray(objeto){
  ...
  // Tu código:
    ...
    //  return Object.entries(objeto); esto devuelve lo mismo que el de arriba pero ya predeterminado.
}
